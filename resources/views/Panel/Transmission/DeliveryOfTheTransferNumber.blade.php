    ...
    <section class="space-y-9">
        <div class="space-y-9 print">
            <div
                ...
                <p>حواله پرفکت مانی شما با موفقیت انجام شد</p>
            </div>
                ...
                <section class="space-y-3">
                    ...
                    <div class=" relative">
                        <div class="flex items-center space-x-3 space-x-reverse">
                            <p>شماره حواله :</p>
                            <span class="text-sm sm:text-base bg-gray-500 px-6 py-1 rounded-md">500</span>
                    ...
                    <div>
                        <div class="flex items-center space-x-3 space-x-reverse">
                            <p>حساب مقصد :</p>
                            <span class="text-sm sm:text-base bg-gray-500 px-6 py-1 rounded-md">U1572232</span>
                        </div>
                    </div>
                </section>
            </section>
        ...
        <section class="flex items-center justify-between">
            ...
            <div
                class="bg-sky-600 rounded-md font-semibold  py-1.5 px-2 box-content w-1/4 text-sm flex items-center justify-center cursor-pointer">
                دریافت رسید
            </div>
        </section>
